...
global.socialm = "ROCKET-V3🚀" //ur github or insta name
...
global.mess = {
    ...
    bot: '❌Entiende, que solo yo puedo usar esta función',
    wait: 'In proceso...',
    linkm: '¿Donde esta el enlace?🤔',
    error: 'Error!',
    ban: 'BANEADO POR ROSQUETE, REGLAS 🥷🏼🥷🏼🥷🏻⚔️.',
    nsfw: '😉La función nsfw no se ha activado pornero, comuníquese con el administrador para activarla😉',
    banChat: 'El bot fue apagado en este grupo, comuníquese con el propietario para activar'
}
global.limitawal = {
    premium: "Infinity",
    free: 2,

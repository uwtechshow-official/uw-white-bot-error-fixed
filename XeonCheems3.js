...
if (!m.isGroup) return replay(mess.group)
if (!isAdmins && !isCreator) return replay(mess.admin)
let teks = `╚» 〽️ 𝗜𝗡𝗩𝗢𝗖𝗔𝗡𝗗𝗢 〽️ «╝
 
 〽️ *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 〽️ 𝗢𝗪𝗡𝗘𝗥 」	
╠ ${prefix}self
╠ ${prefix}public
╠ ${prefix}antitag
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 〽️𝗢𝗪𝗡𝗘𝗥 」	
╠ ${prefix}self
╠ ${prefix}public
╠ ${prefix}antitag
╠ ${prefix}rentbot [add/del]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝗚𝗥𝗢𝗨𝗣 」	
╠${prefix}groupsetting
╠${prefix}grouplink
╠${prefix}ephemeral [option]
╠${prefix}setgcpp [image]

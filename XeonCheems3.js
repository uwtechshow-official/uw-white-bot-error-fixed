...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNo body is allowed to send ⚠️virus⚠️ in this group, member who send will be kicked immediately!🥷🏼🥷🏼🥷🏼`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {

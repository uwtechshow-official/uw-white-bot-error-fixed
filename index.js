...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: '𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗼 𝗮𝗹 𝗴𝗿𝘂𝗽𝗼, 𝗻𝗼 𝘁𝗲 𝗼𝗹𝘃𝗶𝗱𝗲𝘀 𝗱𝗲 𝗹𝗲𝗲𝗿 𝗹𝗮𝘀 𝗿𝗲𝗴𝗹𝗮𝘀 𝗵𝗲!!!'}, type: 1}
]
let buttonMessage = {
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: '𝗘𝘀𝘁𝗮𝗿𝗲𝗺𝗼𝘀 𝗺𝗲𝗷𝗼𝗿 𝘀𝗶𝗻 𝘁𝗶́🤘🏻'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
